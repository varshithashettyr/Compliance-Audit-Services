...
export function ServicesExplorer() {
  ...
  const baseKeyServices: KeyService[] = [
    {
  name: "ISMS Audits / ISO 27001",
  href: "https://www.brickworkindia.com/compliance-and-audit-services/isms-audits-iso-27001",
  color: LOGO_COLORS.blue,
  icon: ShieldCheck,
  subServices: [
    ["ISMS Audits / ISO 27001 Readiness Check", ShieldCheck],
    ["Internal Review", SearchCheck],
    ["Evidence Control and Documentation", FileCheck],
    ["Virtual Audit Support", MonitorCheck],
    ["Vendor Risk Review", UserCheck],
    ["Post-Audit Improvement Planning", TrendingUp],
  ].map(([name, icon]) => ({
    name: name as string,
    href: "https://www.brickworkindia.com/compliance-and-audit-services/isms-audits-iso-27001",
...
{
  name: "QMS Audits / ISO 9001",
  href: "https://www.brickworkindia.com/compliance-and-audit-services/qms-audits-iso-9001",
  color: LOGO_COLORS.green,
  icon: ClipboardCheck,
  subServices: [
    ["Readiness Assessment", ClipboardCheck],
    ["Internal Audit Execution", FileSearch],
    ["Audit Documentation Control", FileCheck],
    ["Virtual Audit Simulation", MonitorCheck],
    ["Vendor Quality Review", UserCheck],
    ["Corrective Action Support", Wrench],
  ].map(([name, icon]) => ({
    name: name as string,
    href: "https://www.brickworkindia.com/compliance-and-audit-services/qms-audits-iso-9001",
    icon: icon as ElementType,
...

{
  ...
  icon: Scale,
  subServices: [
    ["GDPR Readiness Assessment & Audit Preparation", ShieldCheck],
    ["HIPAA Readiness & Compliance Support", LockKeyhole],
    ["DPDPA Readiness", ShieldCheck],
    ["Vendor & Third-Party Risk Assessment", Users],
    ["Compliance Dashboards & Ongoing Monitoring", LayoutDashboard],
    ["Virtual Training & Awareness Programs", GraduationCap],
    ["Audit Readiness & Mock Audits", ClipboardCheck],
  ].map(([name, icon]) => ({
    name: name as string,
    href: "https://www.brickworkindia.com/compliance-and-audit-services/regulatory-readiness-gdpr-dpdpa-hipaa",
    icon: icon as ElementType,
...
{
  name: "Vendor Risk Assessment Services",
  href: "https://www.brickworkindia.com/compliance-and-audit-services/vendor-risk-assessment",
  color: LOGO_COLORS.orange,
  icon: ShieldAlert,
  subServices: [
    ["Third Party Vendor Risk Assessment", Users],
    ["Vendor Security Risk Assessment", ShieldCheck],
    ["Vendor Due Diligence & Compliance Reviews", FileCheck],
    ["Continuous Monitoring & Risk Remediation", Activity],
    ["Vendor Assessment Readiness", ClipboardCheck],
  ].map(([name, icon]) => ({
    name: name as string,
    href: "https://www.brickworkindia.com/compliance-and-audit-services/vendor-risk-assessment",
    icon: icon as ElementType,
